...
const Order = () => {
  ...
  const handleSearchByDate = async () => {
    const response = await axios.get(
      `http://localhost:5000/api/orders/ordersdetails/date/${startDate}/${endDate}`
    );
    ...
    <div className="bg-white rounded-lg shadow-lg overflow-hidden">
     ...
     <button
        ...
        <input
          ...
          className="border border-gray-300 rounded p-2 w-1/4 mb-4"
        />
        <button
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    ...
                    {showModel === orderItem._id && (
                      <div className="bg-gray-800 text-white absolute right-4 mt-2 flex flex-col gap-2 p-4 rounded-md shadow-lg z-50">
                        ...
                        <button
                          onClick={() =>
                            handleStatusChange(orderItem._id, "shipped")
                          }
                        ...
                        <button
                          onClick={() =>
                            handleStatusChange(orderItem._id, "packed")
                          }
                          className="bg-purple-500 hover:bg-purple-600 text-white py-2 px-4 rounded transition duration-200"
                        >
                          Pack
                        </button>
                        <button
                          onClick={() =>
                            handleStatusChange(orderItem._id, "delivered")
                          }
      ...
      >
        ...
        <textarea
          ...
          className="w-full h-32 mt-4 outline-none border border-gray-300 rounded-md p-2"
        />
        <button
          onClick={handleCancelOrder}
          className="bg-red-500 text-white py-2 px-4 rounded mt-"
        >
          Confirm Cancel
        </button>
      </Modal>
